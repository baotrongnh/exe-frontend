...
**Endpoint**: `PUT /api/admin/jobs/:jobId/review`  
**Auth**: Required ✅ (Admin)  
...
**Endpoint**: `PUT /api/applications/:applicationId/withdraw`  
**Auth**: Required ✅  
...
**Endpoint**: `GET /api/cvs/:id/download`  
**Auth**: Required ✅  
...
**Endpoint**: `PATCH /api/cvs/:id/set-primary`  
**Auth**: Required ✅  
