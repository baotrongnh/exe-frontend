        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Please provide a clear reason for rejecting this product. This will help the freelancer understand what
                ...
                <div className="space-y-4 py-4">
                    {deliverable && (
                        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                            ...
                            <p className="text-sm text-gray-600">Freelancer Product</p>
                        </div>
                    )}
                    <div>
