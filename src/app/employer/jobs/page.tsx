                    ...
                    <div className="flex items-center justify-between p-4 border-b border-gray-200">
                         <div className="flex gap-1">
                              <button
                                   ...
                                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "all" ? "bg-indigo-50 text-indigo-600" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                              >
                                   All ({jobs.length})
                              </button>
                              <button
                                   ...
                                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "active" ? "bg-indigo-50 text-indigo-600" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                              >
                              ...
                              <button
                                   ...
                                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "pending" ? "bg-indigo-50 text-indigo-600" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                              >
                              ...
                              <button
                                   ...
                                   className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTab === "closed" ? "bg-indigo-50 text-indigo-600" : "text-gray-600 hover:bg-gray-50"
                                        }`}
                              >
                         ...
                         <div className="flex items-center gap-2">
                              <button
                                   ...
                                   className={`p-2 rounded-lg transition-colors ${viewMode === "list" ? "bg-indigo-50 text-indigo-600" : "text-gray-400 hover:bg-gray-50"
                                        }`}
                              >
                                   <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              ...
                              <button
                                   ...
                                   className={`p-2 rounded-lg transition-colors ${viewMode === "grid" ? "bg-indigo-50 text-indigo-600" : "text-gray-400 hover:bg-gray-50"
                                        }`}
                              >
                                   <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path
                                        ...
                                        >
                                             ...
                                             <div className="flex items-center gap-3">
                                                  <Link
                                                       ...
                                                       className="flex-1 px-4 py-2 bg-indigo-600 text-white rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors text-center"
                                                  >
                                                       View Applications
                                                  </Link>
