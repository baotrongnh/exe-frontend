...
function LoginContent() {
     ...
     // Google login với Supabase OAuth
     ...
     // Email/Password login với Supabase
     const handleEmailLogin = async (formData: { email: string; password: string; rememberMe: boolean }) => {
          try {
     ...
     const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
          ...
          await handleEmailLogin(loginData)
     }
